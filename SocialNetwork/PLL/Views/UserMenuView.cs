    ...
    public class UserMenuView
    {
        ...
        public void Show(User user)
        {
            while (true)
            {
                ...
                Console.WriteLine("Исходящие сообщения: {0}", user.AddFriends.Count());
                ...
                Console.WriteLine("Просмотреть добавленных друзей (нажмите 7)");
                    ...
                    case "7":
                        {
                            ...
                            Program.userFriends.Show(user.AddFriends);
                            break;
                        }
                }
            }
